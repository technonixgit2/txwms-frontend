...
let SecuformComponent = class SecuformComponent {
    constructor(router, fb, security, route, toastr) {
        this.router = router;
        this.fb = fb;
...
SecuformComponent.ctorParameters = () => [
...
let SecurityComponent = class SecurityComponent {
    constructor(router, fb, toastr, security, route) {
        this.router = router;
        this.fb = fb;
        this.toastr = toastr;
        this.security = security;
