...
let ProductsformComponent = class ProductsformComponent {
    constructor(fb, purchaseService, toster) {
        this.fb = fb;
    ...
    ngOnInit() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(value => this.searchsupply(value))).subscribe(res => {
    ...
    loadForm(data) {
        ...
        for (let line = 1; line < data.invoice.length; line++) {
            const invoiceFormArray = this.purchaseForm.get("invoice");
...
let ReceiptorderComponent = class ReceiptorderComponent {
    constructor(router, purchaseService, toster, excelService) {
        this.router = router;
        this.purchaseService = purchaseService;
        this.toster = toster;
...
ReceiptorderComponent.ctorParameters = () => [
...
let ReceivFormComponent = class ReceivFormComponent {
    constructor(fb, router, addreceiveService, toster) {
        this.fb = fb;
        this.router = router;
...
ReceivFormComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let RecevingPCComponent = class RecevingPCComponent {
    constructor(http, router, receivingservice, toster) {
        this.http = http;
        this.router = router;
...
RecevingPCComponent.ctorParameters = () => [
...
let RecevingRFComponent = class RecevingRFComponent {
    constructor(router, http, receivepcservice) {
        this.router = router;
        this.http = http;
...
RecevingRFComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
...
let SuppliertableComponent = class SuppliertableComponent {
...
SuppliertableComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
