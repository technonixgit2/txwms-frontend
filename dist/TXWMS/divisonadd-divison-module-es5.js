(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["divisonadd-divison-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDivisonModule = /** @class */ (function () {
                function AddDivisonModule() {
                }
                return AddDivisonModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DivisonaddComponent = /** @class */ (function () {
                function DivisonaddComponent(http, router, storageService, toster, fb) {
                    this.http = http;
                    this.router = router;
                ...
                DivisonaddComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.dtOptions = {
                    ...
                    this.storageService.getDivision().subscribe(function (data) {
                        _this.getdata = data;
                        _this.getdata.forEach(function (dat) {
                            var abc = ((dat.used / dat.quantity) * 100).toFixed(2);
                            console.log(_this.abc, _this.getdata, 'daaa');
                            _this.percent.push({ division: dat.division, avalible: dat.avalible, quantity: dat.quantity,
                                rack: dat.rack, selected: dat.selected, used: dat.used, percentage: abc
                            });
                        });
                        _this.final = _this.percent;
                        _this.dtTrigger.next();
                    });
                };
                DivisonaddComponent.prototype.ngOnDestroy = function () {
                    // Do not forget to unsubscribe the event
                    this.dtTrigger.unsubscribe();
                };
                DivisonaddComponent.prototype.editEx = function () {
                ...
                //   })
                // }
                DivisonaddComponent.prototype.addform = function () {
                    this.router.navigate(['/storage/createdivison/creatingdivision']);
                };
                return DivisonaddComponent;
            }());
            DivisonaddComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDivisionRoutingModule = /** @class */ (function () {
                function AddDivisionRoutingModule() {
                }
                return AddDivisionRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DivisonformComponent = /** @class */ (function () {
                function DivisonformComponent(fb, router, storageservice, toster) {
                    this.fb = fb;
                    this.router = router;
                    this.storageservice = storageservice;
                    this.toster = toster;
                }
                DivisonformComponent.prototype.ngOnInit = function () {
                ...
                DivisonformComponent.prototype.postpc = function (value) {
                    var _this = this;
                    var quan = value.quantity;
                    value.avalible = quan;
                    if (value._id == '') {
                        this.storageservice.postDivision(value).subscribe(function (data) {
                            console.log(data, 'add');
                            _this.toster.success('added successfully');
                        });
                    }
                    else {
                        this.storageservice.putDivision(value).subscribe(function (data) {
                            console.log(data);
                            _this.toster.success('edit successfully');
                        });
                    }
                };
                return DivisonformComponent;
            }());
            DivisonformComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=divisonadd-divison-module-es5.js.map
//# sourceMappingURL=divisonadd-divison-module-es5.js.map