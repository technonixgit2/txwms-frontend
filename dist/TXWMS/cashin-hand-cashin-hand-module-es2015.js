...
let HandRoutingModule = class HandRoutingModule {
};
...
let CashinHandComponent = class CashinHandComponent {
    constructor(router, handService, toster) {
        this.router = router;
...
CashinHandComponent.ctorParameters = () => [
...
let HandModule = class HandModule {
};
...
let HandService = class HandService {
    constructor(http) {
        this.http = http;
...
let HandformComponent = class HandformComponent {
    constructor(router, fb, handService, toster) {
        this.router = router;
        this.fb = fb;
        this.handService = handService;
        this.toster = toster;
...
HandformComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
