...
let BasicCollapseComponent = class BasicCollapseComponent {
    constructor(router, stockService, bilingService, excelService) {
        this.router = router;
...
BasicCollapseComponent.ctorParameters = () => [
...
let StockoutService = class StockoutService {
    constructor(http) {
        this.http = http;
    }
    getStock() {
...
StockoutService.ctorParameters = () => [
...
let StockoutformComponent = class StockoutformComponent {
...
StockoutformComponent.ctorParameters = () => [
