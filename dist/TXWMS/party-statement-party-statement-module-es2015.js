...
let PartyStatementRoutingModule = class PartyStatementRoutingModule {
};
...
let PartyStatementComponent = class PartyStatementComponent {
    constructor(fb, router, billingService, excelService) {
        this.fb = fb;
        this.router = router;
...
PartyStatementComponent.ctorParameters = () => [
...
let PartyStatementReportModule = class PartyStatementReportModule {
};
