(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["lowstock-report-lowstock-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LowStockRoutingModule = /** @class */ (function () {
                function LowStockRoutingModule() {
                }
                return LowStockRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LowstockReportComponent = /** @class */ (function () {
                function LowstockReportComponent(router, stockService, purchaseService, returnservice, excelService) {
                    this.router = router;
                    ...
                    this.purchaseService.getPurchaseData().subscribe(function (data) {
                        ...
                        _this.returnservice.getReturn().subscribe(function (data) {
                            ...
                            _this.itemin.forEach(function (data) {
                                if (data.Balance <= 100) {
                                    _this.lowstock.push(data);
                                }
                                else {
                                }
                            });
                            console.log(_this.lowstock, 'last data');
                ...
                LowstockReportComponent.prototype.ngOnDestroy = function () {
                    // Do not forget to unsubscribe the event
                    this.dtTrigger.unsubscribe();
                };
                LowstockReportComponent.prototype.exportToExcel = function (event) {
                    var _this = this;
                    this.Excel = [];
            ...
            LowstockReportComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LowStockModule = /** @class */ (function () {
                function LowStockModule() {
                }
                return LowStockModule;
            }());
...
//# sourceMappingURL=lowstock-report-lowstock-module-es5.js.map
//# sourceMappingURL=lowstock-report-lowstock-module-es5.js.map