(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["storageview-storageview-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StorageviewComponent = /** @class */ (function () {
                function StorageviewComponent(storageService) {
                ...
                StorageviewComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.storageService.getDivision().subscribe(function (data) {
                        ...
                        _this.finalRack = div;
                        _this.finalRack.forEach(function (dat) {
                            _this.divison.push({ division: dat.division });
                        });
                        _this.div = _this.divison;
                        console.log(_this.div, 'divi');
                        // const result = Array.from(this.finalRack.reduce((m, t) => m.set(t.name, t), new Map()).values());
                    });
                    this.storageService.getDivision().subscribe(function (data) {
                        _this.rac = data;
                        _this.rac.forEach(function (element) {
                            _this.rackar.push(element);
                        });
                        _this.rackar.forEach(function (dat) {
                        ...
                        var list = _this.percent;
                        var grouped = _this.groupBy(list, function (pet) { return pet.division; });
                        _this.kgf = grouped;
                        _this.dic = _this.kgf;
                        _this.div.forEach(function (dat) {
                            var one = grouped.get(dat.division);
                            _this.on.push({ division: dat.division, array: one });
                        });
                        console.log(_this.on, 'on');
                        console.log(_this.dic, 'kk');
                    });
                };
                // get grouped() { return Array.from(this.dic.entries()); }
                StorageviewComponent.prototype.groupBy = function (list, keyGetter) {
                    var map = new Map();
                ...
                return StorageviewComponent;
            }());
            StorageviewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StorageViewModule = /** @class */ (function () {
                function StorageViewModule() {
                }
                return StorageViewModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StorageviewRoutingModule = /** @class */ (function () {
                function StorageviewRoutingModule() {
                }
                return StorageviewRoutingModule;
            }());
...
//# sourceMappingURL=storageview-storageview-module-es5.js.map
//# sourceMappingURL=storageview-storageview-module-es5.js.map