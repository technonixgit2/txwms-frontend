...
let ProfitLossRoutingModule = class ProfitLossRoutingModule {
};
...
let ProfitLossComponent = class ProfitLossComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ProfitLossReportModule = class ProfitLossReportModule {
};
