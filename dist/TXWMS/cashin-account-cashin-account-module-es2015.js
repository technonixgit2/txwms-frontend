...
let AccountformComponent = class AccountformComponent {
    constructor(router, fb, accountService, toster) {
        this.router = router;
        this.fb = fb;
...
let CashinAccountComponent = class CashinAccountComponent {
    constructor(router, accountService, toster) {
        this.router = router;
        this.accountService = accountService;
        this.toster = toster;
        this.dtOptions = {};
...
CashinAccountComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
