(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["day-book-day-book-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DayBookComponent = /** @class */ (function () {
                function DayBookComponent(router, salesService, toster, customerservice, excelService) {
                    this.router = router;
                ...
                DayBookComponent.prototype.ngOnInit = function () {
                    ...
                    this.salesService.getInvProduct().subscribe(function (data) {
                        ...
                        _this.getData.forEach(function (dataa) {
                            var count = 0;
                            dataa.paid.forEach(function (ele) {
                                count = count + parseInt(ele.amountPaid);
                            });
                            _this.array.push({ Date: dataa.date, Name: dataa.name, Invoice: dataa.overAllInvoiceAmount,
                    ...
                    this.customerservice.getCustomer().subscribe(function (data) {
                        _this.getDat = data;
                        console.log(_this.getDat, 'getfa');
                        _this.getDat.forEach(function (element) {
                            var count = 0;
                        ...
                        console.log(_this.array, 'arr');
                    });
                };
                DayBookComponent.prototype.update = function (data) {
                    var value = data;
                    console.log(value, 'cust');
                };
                DayBookComponent.prototype.getValue = function (value, isChecked) {
                    if (isChecked) {
                ...
                DayBookComponent.prototype.exportToExcel = function (event) {
                    var _this = this;
                    ...
                    if (this.checklist.length == 0) {
                        ...
                        event.forEach(function (dat) {
                            ...
                            var obj = Object.assign({ Date: Date, Name: Name, Invoice: Invoice, Credit: Credit, Paid: Paid, Balance: Balance });
                ...
                //   this.excelService.exportAsExcelFile( this.Excel, 'persons');
                // }
                DayBookComponent.prototype.from = function (event) {
                    this.fdate = event;
                    console.log(event, 'fromdate');
                };
                DayBookComponent.prototype.to = function (event) {
                    this.tdate = event;
                    console.log(event, 'fromdate');
                    this.Date();
                };
                DayBookComponent.prototype.Date = function () {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DayBookReportModule = /** @class */ (function () {
                function DayBookReportModule() {
                }
                return DayBookReportModule;
            }());
...
//# sourceMappingURL=day-book-day-book-module-es5.js.map
//# sourceMappingURL=day-book-day-book-module-es5.js.map