...
let AllTransactionRoutingModule = class AllTransactionRoutingModule {
};
...
let AllTransactionComponent = class AllTransactionComponent {
    constructor(router, salesService, customerservice) {
        this.router = router;
...
AllTransactionComponent.ctorParameters = () => [
...
let AllTransactionReportModule = class AllTransactionReportModule {
};
