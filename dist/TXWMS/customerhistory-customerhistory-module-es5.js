(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customerhistory-customerhistory-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerhistoryRoutingModule = /** @class */ (function () {
                function CustomerhistoryRoutingModule() {
                }
                return CustomerhistoryRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerhistoryComponent = /** @class */ (function () {
                function CustomerhistoryComponent(router, salesService, toster, customerservice) {
                    this.router = router;
                ...
                CustomerhistoryComponent.prototype.ngOnInit = function () {
                    ...
                    this.salesService.getInvProduct().subscribe(function (data) {
                        ...
                        _this.getData = data;
                        _this.datefilter = _this.getData;
                ...
                CustomerhistoryComponent.prototype.update = function (data) {
                    var value = data;
                    localStorage.removeItem('sale');
                    localStorage.setItem('sale', JSON.stringify(value));
                    this.router.navigate(['/finance/customerhistory/history']);
                };
                CustomerhistoryComponent.prototype.from = function (event) {
                    this.fdate = event;
                    console.log(event, 'fromdate');
                };
                CustomerhistoryComponent.prototype.to = function (event) {
                    this.tdate = event;
                    console.log(event, 'fromdate');
                    this.Date();
                };
                CustomerhistoryComponent.prototype.Date = function () {
                    var _this = this;
                    ...
                    filter.forEach(function (element) {
                        element.paid.forEach(function (ele) {
                            _this.paid.push({ amount: ele.amountPaid });
                        });
                        var bal = element.balance;
                        _this.balance = _this.balance + Number.parseFloat(bal);
                        var mp = element.credit;
                        _this.credit = _this.credit + Number.parseFloat(mp);
                    });
                    this.paid.forEach(function (mint) {
                        var mp = mint.amount;
                        _this.Apaid = _this.Apaid + Number.parseFloat(mp);
                    });
                    this.tap = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerhistoryModule = /** @class */ (function () {
                function CustomerhistoryModule() {
                }
                return CustomerhistoryModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            /* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
            var CustomerhistorydetailsComponent = /** @class */ (function () {
                function CustomerhistorydetailsComponent(fb, salesServicew, customerSerice, toster) {
                    this.fb = fb;
                ...
                CustomerhistorydetailsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var amount = 0;
                    ...
                    //   this.data=dat
                    this.arr.forEach(function (dat) {
                        _this.balance = dat.balance;
                        _this.total = 0;
                        dat.paid.forEach(function (da) {
                            var mp = da.amountPaid;
                            _this.total = _this.total + Number.parseFloat(mp);
                            console.log(_this.total + Number.parseFloat(mp));
                        });
                    });
                ...
                CustomerhistorydetailsComponent.prototype.dataget = function () {
                ...
                //   })
                // }
                CustomerhistorydetailsComponent.prototype.createItem = function () {
                    return this.fb.group({
                        // _id:[''],
                        dat: [''],
                        amountPaid: [''],
                ...
                Object.defineProperty(CustomerhistorydetailsComponent.prototype, "paid", {
                    // get products() {
                ...
                CustomerhistorydetailsComponent.prototype.loadForm = function (data) {
                ...
                Object.defineProperty(CustomerhistorydetailsComponent.prototype, "product", {
                    get: function () {
                        return this.fb.group({
                            _id: '',
                            itemCode: '',
                ...
                CustomerhistorydetailsComponent.prototype.onSubmit = function (val) {
                    var _this = this;
                    ...
                    this.salesServicew.putProduct(val).subscribe(function (data) {
                ...
                CustomerhistorydetailsComponent.prototype.update = function (val) {
                    console.log(val, 'salesupdate');
                    this.SaleForm.patchValue(val);
                };
                return CustomerhistorydetailsComponent;
            }());
            CustomerhistorydetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BillingService = /** @class */ (function () {
                ...
                BillingService.prototype.getProduct = function () {
                    var _this = this;
...
//# sourceMappingURL=customerhistory-customerhistory-module-es5.js.map
//# sourceMappingURL=customerhistory-customerhistory-module-es5.js.map