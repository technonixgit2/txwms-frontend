(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["item-wise-profit-item-wise-profit-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemWiseRoutingModule = /** @class */ (function () {
                function ItemWiseRoutingModule() {
                }
                return ItemWiseRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemWiseProfitComponent = /** @class */ (function () {
                function ItemWiseProfitComponent(billingService, purchaseService, excelService) {
                ...
                ItemWiseProfitComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.dtOptions = {
                ...
                ItemWiseProfitComponent.prototype.getPurchase = function () {
                    var _this = this;
                ...
                ItemWiseProfitComponent.prototype.setchange = function (selectedvalue) {
                    var _this = this;
                ...
                ItemWiseProfitComponent.prototype.exportToExcel = function (event) {
                    var _this = this;
                    this.Excel = [];
                    event.forEach(function (dat) {
                        ...
                        var obj = Object.assign({ ItemCode: ItemCode, ItemName: ItemName, Quantity: Quantity, Total: Total, Profit: Profit });
                        _this.Excel.push(obj);
                    });
                    this.excelService.exportAsExcelFile(this.Excel, 'persons');
                };
                return ItemWiseProfitComponent;
            }());
            ItemWiseProfitComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemWiseProfitModule = /** @class */ (function () {
                function ItemWiseProfitModule() {
                }
                return ItemWiseProfitModule;
            }());
...
//# sourceMappingURL=item-wise-profit-item-wise-profit-module-es5.js.map
//# sourceMappingURL=item-wise-profit-item-wise-profit-module-es5.js.map