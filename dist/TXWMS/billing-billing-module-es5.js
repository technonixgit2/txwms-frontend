(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["billing-billing-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BillingComponent = /** @class */ (function () {
                function BillingComponent(addProductService, salesErvice, fb, supplierService, customerService, router, toster
                ...
                BillingComponent.prototype.ngOnInit = function () {
                    ...
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function (value) { return _this.search(value); })).subscribe(function (res) {
                        _this.result_list = res;
                    ...
                    // tap(() => this.isLoading = true),
                    // debounce(() => interval(1000)),
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function (value) { return _this.searchsupply(value); })).subscribe(function (res) {
                    ...
                    this.addProductService.getProduct().subscribe(function (data) {
                        ...
                        console.log(_this.searchData, 'kkkk');
                    });
                    this.salesErvice.refreshNeeded$.subscribe(function () {
                        _this.getFuction();
                    });
                    this.getSales();
                    this.getSuplier();
                ...
                BillingComponent.prototype.createItem = function () {
                ...
                BillingComponent.prototype.dataget = function () {
                    this.SaleForm = this.fb.group({
                        _id: [''],
                        branchId: this.id,
                        branchName: this.Name,
                ...
                BillingComponent.prototype.loadForm = function (data) {
                    //create lines array first
                    for (var line = 1; line < data.products.length; line++) {
                        var productsFormArray = this.SaleForm.get("products");
                        productsFormArray.push(this.product);
                    }
                    //patch the form:
                    for (var lin = 1; lin < data.paid.length; lin++) {
                        var paidFormArray = this.SaleForm.get("paid");
                        paidFormArray.push(this.paid);
                    }
                };
                Object.defineProperty(BillingComponent.prototype, "product", {
                    get: function () {
                        return this.fb.group({
                            _id: '',
                            branchId: this.id,
                ...
                Object.defineProperty(BillingComponent.prototype, "paid", {
                    get: function () {
                        return this.fb.group({
                            _id: '',
                            dat: '',
                ...
                BillingComponent.prototype.getFuction = function () {
                    var _this = this;
                    this.salesErvice.getInvProduct().subscribe(function (data) {
                        _this.invoice = data;
                        console.log(_this.invoice, 'totalinv');
                    });
                };
                BillingComponent.prototype.addItem = function () {
                    this.change++;
                    console.log(this.change, 'change');
                    this.products = this.SaleForm.get('products');
                    this.products.push(this.createItem());
                };
                BillingComponent.prototype.deleteAddressGroup = function (index) {
                    this.change--;
                    console.log(this.change, 'change');
                    var add = this.SaleForm.get('products');
                    add.removeAt(index);
                    this.hhh.splice(index, 1);
                };
                BillingComponent.prototype.keyup1 = function (event) {
                    console.log(event, 'event');
                };
                BillingComponent.prototype.removeGroup = function (index) {
                    var add = this.SaleForm.get('products');
                    add.at(index).reset();
                    this.hhh.splice(index, 1);
                    console.log(this.hhh, 'event');
                };
                BillingComponent.prototype.search = function (keyword) {
                    this.itemLength2 = keyword.length;
                    console.log(keyword.length);
                    var emp = [keyword];
                    var key = keyword.toLowerCase();
                    var dis = [key];
                    var result = this.searchData.filter(function (e) { return (e.itemCode.indexOf(emp) !== -1 || e.description.toLowerCase().indexOf(dis) !== -1); });
                ...
                BillingComponent.prototype.searchsupply = function (keyword) {
                    ...
                    var result = this.getSuppliers.filter(function (e) {
                        ...
                        return e.name.toLowerCase().indexOf(emp) !== -1;
                    });
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(result);
                };
                BillingComponent.prototype.editData = function (value) {
                ...
                BillingComponent.prototype.getSuppliersData = function (value) {
                    this.itemLength = 0;
                    // var val=value
                ...
                BillingComponent.prototype.getSuplier = function () {
                    var _this = this;
                ...
                BillingComponent.prototype.onSubmit = function (val) {
                    var _this = this;
                    console.log('in');
                    if (val._id == " ") {
                        // val.overAllInvoiceTotal=val.overAllInvoiceAmount
                        // val.balance=val.overAllInvoiceAmount
                        this.salesErvice.postInvProduct(val).subscribe(function (data) {
                            console.log(data);
                        ...
                        this.CGST = 0;
                        this.Totalamount = 0;
                        val.products.forEach(function (dat) {
                            _this.Totalamount = _this.Totalamount + dat.col33;
                            _this.CGST = _this.CGST + Number.parseFloat(dat.CGSTAmount);
                            _this.SGST = _this.SGST + Number.parseFloat(dat.SGSTAmount);
                        ...
                        this.salesErvice.putInvProduct(val).subscribe(function (data) {
                            console.log(data);
                            _this.test = false;
                            _this.table = true;
                        });
                ...
                BillingComponent.prototype.getProduct = function (value) {
                    if (this.change == 0) {
                        this.hhh = [];
                    }
                    this.itemLength2 = 0;
                ...
                BillingComponent.prototype.getSales = function () {
                    var _this = this;
                    this.salesErvice.getInvProduct().subscribe(function (data) {
                        _this.salesData = data;
                        console.log(_this.salesData, 'buttonsales');
                    });
                };
                BillingComponent.prototype.viewBilling = function (data) {
                    this.patchValues.push(data);
                };
                BillingComponent.prototype.back = function () {
                    this.test = true;
                };
                BillingComponent.prototype.printPage = function () {
                    window.print();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditbillComponent = /** @class */ (function () {
                function EditbillComponent(addProductService, saleService, fb, supplierService, toster, customerService) {
                    this.addProductService = addProductService;
                    this.saleService = saleService;
                    this.fb = fb;
                    this.supplierService = supplierService;
                ...
                EditbillComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.addProductService.getProduct().subscribe(function (data) {
                        _this.searchData = data;
                        console.log(_this.searchData, 'kkkk');
                ...
                EditbillComponent.prototype.deleteAddressGroup = function (index) {
                    this.hhh.forEach(function (data) {
                ...
                EditbillComponent.prototype.removeGroup = function (index) {
                    this.hhh.forEach(function (data) {
                        console.log(data, 'remove data');
                        console.log(data, 'puted');
                    });
                ...
                EditbillComponent.prototype.dataget = function () {
                    this.SaleForm = this.fb.group({
                        _id: [''],
                        name: [''],
                        itemC: [''],
                ...
                EditbillComponent.prototype.loadForm = function (data) {
                    //create lines array first
                    for (var line = 1; line < data.products.length; line++) {
                        var productsFormArray = this.SaleForm.get("products");
                        productsFormArray.push(this.product);
                ...
                Object.defineProperty(EditbillComponent.prototype, "product", {
                    get: function () {
                        return this.fb.group({
                            _id: '',
                            itemCode: '',
                ...
                //   }) 
                // }
                EditbillComponent.prototype.onSubmit = function (val) {
                    var _this = this;
                ...
                EditbillComponent.prototype.add = function () {
                    this.products = this.SaleForm.get('products');
                    this.products.push(this.product);
                };
                EditbillComponent.prototype.enableSection = function (index, disabled) {
                    var capabilityFormGroup = this.SaleForm.get('products').at(index);
                    disabled ? capabilityFormGroup.enable() : capabilityFormGroup.disable();
                    console.log(disabled, 'disable');
                    console.log(index, 'index');
                };
                EditbillComponent.prototype.getProduct = function (value) {
                    this.searchText = "";
                    this.gone = false;
                    value.idate = this.dater;
                    this.hhh.push(value);
                ...
                EditbillComponent.prototype.update = function (val) {
                    console.log(val, 'salesupdate');
                    this.SaleForm.patchValue(val);
                };
                return EditbillComponent;
            }());
            EditbillComponent.ctorParameters = function () { return [
                { type: _pages_core_chart_crt_morris_addproduct_service__WEBPACK_IMPORTED_MODULE_3__["AddproductService"] },
                { type: _sales_service__WEBPACK_IMPORTED_MODULE_5__["SalesService"] },
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: _pages_form_elements_basic_elements_supplier_service__WEBPACK_IMPORTED_MODULE_4__["SupplierService"] },
